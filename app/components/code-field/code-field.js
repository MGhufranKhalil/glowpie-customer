...
import {SM, isAutoFillSupported} from '../../utils/helpers';
import {font, color, styles, typography} from '../../theme';
...
export class CodeField extends Component {
  ...
  static defaultProps = {
    ...
    codeInputHighlightStyle: defaultHighlightStyle,
    onCodeFilled: null,
  ...
  handleKeyPressTextInput = (index, key) => {
    console.tron.log('code field key pressed');
    const digits = this.getDigits();
    if (key === 'Backspace') {
