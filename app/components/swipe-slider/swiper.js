...
export class Swiper extends Component {
  ...
  loopJump = () => {
    ...
    this.loopJumpTimer = setTimeout(
      ...
      scrollView && scrollView.setPageWithoutAnimation ? 50 : 300,
    );
  };
